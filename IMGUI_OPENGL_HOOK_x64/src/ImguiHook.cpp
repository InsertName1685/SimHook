...
SimHook wglSwapBuffers_Hook((BYTE*)GetProcAddress(GetModuleHandle(L"opengl32.dll"), "wglSwapBuffers"), (BYTE*)h_wglSwapBuffers, (BYTE*)&o_wglSwapBuffers, 15);
...
void InitImgui(bool *initiated,HDC hdc)
{
    ...
    o_wndproc = (WNDPROC)SetWindowLongPtrW(values::window, GWLP_WNDPROC, (LONG_PTR)h_wndproc);
...
void Hook_Imgui::DetachHook()
{
    ...
    try
    {
        ...
        SetWindowLongPtrW(values::window, GWLP_WNDPROC, (LONG_PTR)o_wndproc);
    }
